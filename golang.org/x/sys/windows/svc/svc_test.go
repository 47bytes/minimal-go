...
import (
	...
	"github.com/47bytes/minimal-go/golang.org/x/sys/windows/svc"
	"github.com/47bytes/minimal-go/golang.org/x/sys/windows/svc/mgr"
)
...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "github.com/47bytes/minimal-go/golang.org/x/sys/windows/svc/example").CombinedOutput()
	if err != nil {
